...
import com.aaron.sidegesture.constant.GlobalSettings.MaxBubbleDiameter
import com.aaron.sidegesture.constant.GlobalSettings.MaxBubbleOffset
...
import com.aaron.sidegesture.constant.GlobalSettings.MinBubbleDiameter
import com.aaron.sidegesture.constant.GlobalSettings.MinBubbleOffset
 ...
 */
@Composable
fun BubbleStyleScreen(
    onBack: () -> Unit,
    vm: BubbleStyleVM = viewModel()
) {
    ...
    UDFComponent(
        ...
        Column {
            TopBar(
                onBack = onBack,
                title = stringResource(id = R.string.animation_style_bubble)
            )
            MyColumn(scrollState = scrollState) {
                ...
                MySection(
                    ...
                    MyTextSlider(
                        value = uiState.animationStyle.diameter.toFloat(),
                        onValueChange = vm::onDiameterChange,
                        onValueChangeFinished = vm::saveSettings,
                    ...
                    MyTextSlider(
                        ...
                        onValueChange = vm::onMaxOffsetChange,
                        onValueChangeFinished = vm::saveSettings,
